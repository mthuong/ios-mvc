...
protocol NetworkService {
    ...
    func get<Resource: Decodable>(completion: @escaping (Result<[Resource], Error>) -> Void) -> Void
    func post<Resource: Encodable>(_ resource: Resource, completion: @escaping (Result<ResourceID, Error>) -> Void) -> Void
    mutating func delete<Response: Decodable>(withID resourceID: ResourceID, completion: @escaping (Result<Response, Error>) -> Void) -> Void
    mutating func put<Resource: Encodable, Response: Decodable>(_ resourceID: ResourceID, resource: Resource, completion: @escaping (Result<Response, Error>) -> Void) -> Void
...
struct StandardNetworkService: NetworkService {
    ...
    func get<Resource>(completion: @escaping (Result<[Resource], Error>) -> Void) where Resource : Decodable {
    ...
    func post<Resource>(_ resource: Resource, completion: @escaping (Result<ResourceID, Error>) -> Void) where Resource : Encodable {
        var request = urlRequest.makeURLRequest()
    ...
    mutating func delete<Response>(withID resourceID: ResourceID, completion: @escaping (Result<Response, Error>) -> Void) where Response : Decodable {
    ...
    mutating func put<Resource, Response>(_ resourceID: ResourceID, resource: Resource, completion: @escaping (Result<Response, Error>) -> Void) where Resource : Encodable, Response : Decodable {
        var updatedEndpoint = urlRequest.endpoint
